        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools">
                            <div class="btn-group pull-right" style="margin-right: 5px">
                                <a href="{{ route('admin.article.show',$article->id) }}" class="btn btn-sm btn-primary btn-edit"  data-id="{{ $article->id }}" title="查看">
                    ...
                    <div class="box-body">
                        <form action="{{ route('admin.article.update',$article->id) }}" class="form-horizontal" pjax-container
                            ...
                            <div class="box-body fields-group">
                                <div class="form-group  {!! !$errors->has('title') ?: 'has-error' !!}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="title" name="title" value="{{ $article->title }}" maxlength="255"
                                ...
                                <div class="form-group  {!! !$errors->has('author') ?: 'has-error' !!}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                            <input type="text" id="author" name="author" value="{{ $article->author }}" maxlength="255"
                                ...
                                <div class="form-group {!! !$errors->has('cover') ?: 'has-error' !!}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input id="cover" name="cover" type="file"
                                               data-initial-preview="<img src='{{ $article->cover }}' />" class='file-preview-image'
                                               data-initial-caption="{{ $article->cover }}"
                                ...
                                <div class="form-group  {!! !$errors->has('title') ?: 'has-error' !!}">
                                    ...
                                    <div class="col-sm-8">
                                        @if($errors->has('tag_id'))
                                            ...
                                            @endforeach
                                        @endif
                                        <select class="form-control tag_id select2-hidden-accessible" multiple="multiple"
                                                style="width: 100%;" name="tag_id" data-value="" tabindex="-1" id="tag_id"
                                                aria-hidden="true">
                                            @foreach( $tags as $tag)
                                                <option value="{{ $tag['id'] }}"
                                        ...
                                        @endif
                                            <label class="">
                                                <div class="iradio_minimal-blue checked" aria-checked="true" aria-disabled="false" style="position: relative;">
                                                    ...
                                                    <input type="radio" name="is_top"
                                                           ...
                                                           id="top_1" value="1" class="minimal"  style="position: absolute; opacity: 0;">
                                            ...
                                            <label class="is_top_margin_left">
                                                <div class="iradio_minimal-blue" aria-checked="false" aria-disabled="false" style="position: relative;">
                                                    ...
                                                    <input type="radio" name="is_top" id="top_2"
                                                           @if($article->is_top === 0) checked="checked" @endif
                                                           value="0" class="minimal" style="position: absolute; opacity: 0;">
                                                    <ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                                                </div>
                                            </label>
                                    </div>
                                ...
                                <div class="form-group  {!! !$errors->has('description') ?: 'has-error' !!}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <textarea name="description" class="form-control desc" rows="5" maxlength="255"
                                                  placeholder="输入 描述">{{ $article->description }}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div id="editor">
                                              <textarea name="markdown" style="display:none;"
                                                        placeholder="输入 文章内容">{{ $article->markdown }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>

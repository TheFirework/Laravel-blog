                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <span>
                                <a class="btn btn-sm btn-primary grid-refresh" href="{{ route('admin.auth.users') }}" title="刷新"><i class="fa fa-refresh"></i><span class="hidden-xs"> 刷新</span></a>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="btn-group pull-left " style="margin-left: 10px;">
                                                    <a href="{{ route('admin.auth.users') }}" class="btn btn-default btn-sm"><i class="fa fa-undo"></i>&nbsp;&nbsp;重置</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            i.isError ? (i.$previewContainer.removeClass("file-thumb-loading"), i.$previewStatus.html(""), i.$captionContainer.removeClass("icon-visible")) : i._showFileIcon(), i._setCaption(d, i.isError), i.$container.removeClass("file-input-new file-input-ajax-new"), 1 === arguments.length && i._raise("fileselect", [e, o]),
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, P, I, A, D, z, $, j, U = v + x, R = u + "-" + U, B = i[x], O = m.text, M = m.image,
                    L = m.html, Z = B && B.name ? r.slug(B.name) : "", N = (B && B.size || 0) / 1e3, H = "",
                    q = B ? t.objUrl.createObjectURL(B) : null, W = 0, V = "", K = 0, Y = function () {
